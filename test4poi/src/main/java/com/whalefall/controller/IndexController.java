...
import com.whalefall.service.UserService;
	...
	public HSSFCellStyle getStyle(HSSFWorkbook hssfWorkbook, Integer styleNum) {
		...
		switch (styleNum) {
			case (0): {//HorizontalAlignment
				...
				style.setFont(font);
				palette.setColorAtIndex(BLUE.index, (byte) 184, (byte) 204, (byte) 228);//替换颜色板中的颜色
				style.setFillForegroundColor(BLUE.index);
			...
			case (3): {
				...
				palette.setColorAtIndex(GREEN.index, (byte) 0, (byte) 32, (byte) 96);//替换颜色板中的颜色
